...
// 2 tham so _robotY và _robotX su dung cho ham gia toc Tang toc de tinh gia tri bien Y cua ham giaToc
...
//Tai X = 35
//_robotY = 20 va _robotX = 140 thì Y = 15 
//_robotY = 50 va _robotX = 150 thì Y = 38
//_robotY =  va _robotX =  thì Y = 
//_robotY =  va _robotX =  thì Y = 
//_robotY =  va _robotX =  thì Y = 
...
// Trong hàm robotAnalytics(); dieu chinh tang hoac giam 2 tham so de co the tang toc hoac giam toc ngay lap tuc.
//====================================================================
...
{																	// gia tri acc = 0 tuc robot se ngat xung ngay lap tuc khien banh bi tha troi gây giat khuc
		_robotRunSpeed = 0;
		_robotAccStop = acc;
...
//------------------------------------------------------------------------------
void ac_SpeedACC(int acc, int n)  // Gia toc tang toc. n càng tang thi gia toc ban dau cang nhanh.
